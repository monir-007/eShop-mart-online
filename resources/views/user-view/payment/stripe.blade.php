        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    <li><a href="#">Home</a></li>
                    <li class='active'>Stripe Gateway</li>
                </ul>
                            ...
                            <div class="panel-group">
                                <div class="panel panel-default">
                                    ...
                                    <form action="{{route('stripe.payment')}}" method="post" id="payment-form">
                                        @csrf
                                        <div class="form-row">
                                            <p>testing number: 4242424242424242</p>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe('pk_test_51J7RZqAp8qOK88MHLgOSjtUXgZmPfhpnEIe5v2oWsJo6r8XK6V74R6eOLNseiCgZ38CdKYX9Y4k1hL9XJqAZa4Ug008Pjg9NB6');
