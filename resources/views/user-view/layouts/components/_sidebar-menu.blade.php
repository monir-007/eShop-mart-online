<div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                        ...
                        <li class="yamm-content">
                            <div class="row">
                                ...
                                <div class="dropdown-banner-holder"><a href="#"><img alt=""
                                                                                     src="{{asset('user-view/assets/images/banners/banner-side.png')}}"/></a>
                                </div>
                            </div>
                            <!-- /.row -->
                        </li>
    ...
    <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
        ...
        <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
            <div class="item">
                <div class="products">
                    <div class="hot-deal-wrapper">
                        <div class="image"><img src="{{asset('user-view/assets/images/hot-deals/p25.jpg')}}" alt="">
                        </div>
            ...
            <div class="item">
                <div class="products">
                    <div class="hot-deal-wrapper">
                        <div class="image"><img src="{{asset('user-view/assets/images/hot-deals/p5.jpg')}}" alt="">
                        </div>
            ...
            <div class="item">
                <div class="products">
                    <div class="hot-deal-wrapper">
                        <div class="image"><img src="{{asset('user-view/assets/images/hot-deals/p10.jpg')}}" alt="">
                        </div>
                        <div class="sale-offer-tag"><span>35%<br>
                    off</span></div>
                        <div class="timing-wrapper">
    ...
    <div class="home-banner"><img src="{{asset('user-view/assets/images/banners/LHS-banner.jpg')}}" alt="Image"></div>
</div>
