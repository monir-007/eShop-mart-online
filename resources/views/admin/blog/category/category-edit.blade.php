    ...
    <div class="container-full">
        ...
        <section class="content">
            <div class="row">
                ...
                <!-- =============== Edit New Blog Category ================== -->
                <div class="col-6">
                    <div class="box bt-3">
                        <div class="box-header with-border">
                            <h3 class="box-title text-white">Edit New Category</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('blog.category.update') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name_eng" value="{{$blogCategory->name_eng}}" class="form-control">
                                            @error('name_eng')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name_bng" value="{{$blogCategory->name_bng}}" class="form-control">
                                            @error('name_bng')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
