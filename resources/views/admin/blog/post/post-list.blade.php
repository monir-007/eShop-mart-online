                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Blog Post list</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="box bt-3 border-primary">
                        <div class="box-header with-border">
                            ...
                            <a href="{{route('blog.post.insert')}}" class="btn btn-success" style="float: right">Add New Post</a>
                        </div>
