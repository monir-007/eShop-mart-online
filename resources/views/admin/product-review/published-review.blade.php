                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Published Review list</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="box bt-3 border-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">All Published Review list</h3>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr class="bg-transparent">
                                            @foreach($review as $item)
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{route('product.review.delete',$item->id)}}"
                                                       class="btn btn-danger mr-2"
                                                       id="delete"
                                                       data-toggle="tooltip"
                                                       data-placement="bottom" title="Remove Review"> <i
