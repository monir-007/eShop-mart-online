                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Search Date Reports</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="box bt-3 border-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Order Lists of <span class="text-warning">{{$month}} {{$year}}</span></h3>
                                            ...
                                            @foreach($orders as $item)
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{route('pending.orders.detail',$item->id)}}"
                                                       ...
                                                       data-toggle="tooltip"
                                                       data-placement="bottom" title="View Order"> <i
                                                            class="fa fa-eye"></i> </a>
