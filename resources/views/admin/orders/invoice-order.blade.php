...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        ...
        <!-- {{-- <img src="" alt="" width="150"/> --}} -->
            <h2 style="color: green; font-size: 26px;"><strong>eShopMart</strong></h2>
        </td>
        <td align="right">
            <pre class="font">
               eShopMart Head Office
               Email:support@eshopmartbd.com <br>
               Mob: 1245454545 <br>
...
<table width="100%">
    ...
    @foreach($orderItem as $item)
        <tr class="font">
            ...
            <td align="center">{{$item->product->name_eng}}</td>
            <td align="center">
                @if($item->size=== null)
                    ----
                @else
